...
public class List 
{
    ...
    public void addFirst(char chr) 
    {
        ...
        Node newNode = new Node(newCD);     // creates a new node 
        newNode.next = first;               // new node ! first node 
        first = newNode;                    // first ! new node 
        this.size++;                        // Increases the list size by one.
    }
    ...
    public boolean remove(char chr) 
    {
        ...
        if (prev == null) // Remove the elements. If it's the first element, updates first.
